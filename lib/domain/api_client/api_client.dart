...
class ApiClient {
  ...
  static const String _apiKey = '0dd6840284e9a8dd950be5456a72be85';

  static String imageUrl(String path) => _imageUrl + path;

  Uri _getUri(String path, [Map<String, dynamic>? parameters]) {
    final Uri uri = Uri.parse('$_host$path');
    if (parameters != null) {
  ...
  Future<T> _get<T>(String path, T Function(dynamic json) parser,
    ...
    final url = _getUri(path, parameters);
    try {
  ...
  Future<T> _post<T>(
    ...
    try {
      final url = _getUri(path, urlParameters);
